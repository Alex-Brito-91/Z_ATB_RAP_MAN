CLASS zcl_atb_cargas DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_atb_cargas IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

    TYPES: tt_product  TYPE TABLE OF ztatb_product WITH DEFAULT KEY,
           tt_vendor   TYPE TABLE OF ztatb_vendor WITH DEFAULT KEY,
           tt_company  TYPE TABLE OF ztatb_company WITH DEFAULT KEY,
           tt_customer TYPE TABLE OF ztatb_customer WITH DEFAULT KEY.
    ...
    DELETE FROM ztatb_product.
    DELETE FROM ztatb_vendor.
    DELETE FROM ztatb_company.
    DELETE FROM ztatb_customer.

    MODIFY ztatb_product  FROM TABLE @lt_product.
    MODIFY ztatb_vendor   FROM TABLE @lt_vendor.
    MODIFY ztatb_company  FROM TABLE @lt_company.
    MODIFY ztatb_customer FROM TABLE @lt_customer.
